...
const values = [
  ...
  { icon: Users, title: "Parceria", desc: "Construímos relações sólidas com nossos clientes" },
  { icon: Zap, title: "Inovação", desc: "Buscamos constantemente novas soluções e tecnologias" },
  { icon: Heart, title: "Compromisso", desc: "Dedicação total à satisfação do cliente" },
];
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="font-heading text-4xl md:text-5xl text-secondary mt-2 mb-6">TRADIÇÃO E <span className="text-primary">INOVAÇÃO</span></h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>A Gift Excellence nasceu da paixão por tecnologia e da visão de oferecer ao mercado brasileiro as melhores soluções em máquinas industriais para os segmentos de brindes, personalização e embalagens.</p>
                <p>Ao longo dos anos, construímos uma reputação sólida baseada em atendimento consultivo, qualidade excepcional e suporte técnico especializado. Nossa missão é ser o parceiro ideal para empresas que buscam crescer com eficiência e tecnologia de ponta.</p>
                <p>Com um catálogo completo e uma equipe altamente qualificada, a Gift Excellence se posiciona como referência no mercado, atendendo desde pequenos empreendedores até grandes indústrias.</p>
              </div>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
              <img src="/logo-gift.jpeg" alt="Gift Excellence" className="rounded-xl shadow-2xl w-full" />
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-card rounded-xl p-8 border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed">Oferecer máquinas e equipamentos de alta qualidade, acompanhados de atendimento consultivo e suporte técnico especializado, proporcionando as melhores soluções para nossos clientes crescerem com tecnologia e confiança.</p>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="bg-card rounded-xl p-8 border border-border">
              ...
              <p className="text-muted-foreground leading-relaxed">Ser a principal referência no mercado de máquinas industriais para brindes, personalização e embalagens, reconhecida pela excelência, inovação e compromisso com a satisfação dos nossos parceiros.</p>
            </motion.div>
          </div>
        </div>
      </section>
